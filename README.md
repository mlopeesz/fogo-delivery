...
<details>
  ...
  - Data de entrega para avaliação final do projeto: `26/08/2022 14:00`.
...
<details>
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-017-project-delivery-app/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-017-project-delivery-app/pulls) e confira que o seu _Pull Request_ está criado
...
<details>
  ...
  ➡️ Este projeto já vem com as dependências relacionadas ao _linter_ configuradas nos arquivos `package.json` nos seguintes caminhos:
    - `sd-017-project-delivery-app/back-end/package.json`
    - `sd-017-project-delivery-app/front-end/package.json`
